        ...
        <SidebarLayout
          ...
          sidebar={
            <Sidebar>
              ...
              <SidebarBody>
                <SidebarSection>
                  <SidebarItem href="/service">
                    <HomeIcon />
                    <SidebarLabel>홈</SidebarLabel>
                  </SidebarItem>
                  <SidebarDivider />
                  <SidebarItem href="/service/products/new">
                    <PlusIcon />
                    <SidebarLabel>신규 상품 등록</SidebarLabel>
                  </SidebarItem>
                  <SidebarItem href="/service/products/manage">
                    <ClipboardDocumentListIcon />
                    <SidebarLabel>상품 관리</SidebarLabel>
                  </SidebarItem>
                  <SidebarDivider />
                  <SidebarItem href="/service/orders/manage">
                    <ClipboardDocumentCheckIcon />
                    <SidebarLabel>상품 주문 관리</SidebarLabel>
                  </SidebarItem>
                  <SidebarDivider />
                  <SidebarItem href="/service/inquiries">
                    <UserCircleIcon />
                    <SidebarLabel>고객 문의 관리</SidebarLabel>
                  </SidebarItem>
                  <SidebarDivider />
                  <SidebarItem href="/service/settings/uploads">
                    <CogIcon />
                    <SidebarLabel>기본 업로드 설정</SidebarLabel>
                  </SidebarItem>
                  <SidebarItem href="/service/settings/market">
                    <InboxIcon />
                    <SidebarLabel>마켓 설정</SidebarLabel>
                  </SidebarItem>
                  <SidebarItem href="/service/settings/warning-words">
                    <ShieldExclamationIcon />
                ...
                <SidebarSpacer />
                <SidebarSection>
                  <SidebarItem href="/service/support">
                    <QuestionMarkCircleIcon />
